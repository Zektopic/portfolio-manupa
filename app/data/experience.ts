export const experienceData = [
  {
    ...
    type: "Full-time",
    duration: "Feb 2025 - Present · 10 mos",
    ...
    positions: [
      {
        ...
        description: [
          ...
          "Through the Pipelines alone I managed in reducing user interactions by 80% and cutting deployment times to 20-30 minutes."
        ],
      ...
      },
      {
        ...
        description: [
          "Research and Develop Agritech sensors, equipments and Machinery.",
          "Developed firmware for 32-bit Espressif MCUs using native C and custom C libraries.",
          "Prototyping ATMEGA Based Sensors using ATMEGA SDK.",
          "Built Linux on MIPS32-based microprocessors using OpenWRT and implemented packages/services to run several microservices.",
          ...
          "Designed and implemented embedded software in C.",
          "Debugged and tested embedded systems using measuring instruments and oscilloscopes.",
          "Implemented communication protocols such as UART, I2C, ADC, and RS485.",
          "Developed device drivers for various peripherals.",
          "Participated in code reviews and software testing processes.",
          "Contributed to the maintenance and deployment of hardware.",
          "Involved in PCB prototyping, designing, manufacturing, and testing."
        ],
        businessDevelopment: [
          "Contributed to business development efforts by identifying and pursuing sales leads for our products.",
          "Participated in marketing activities to promote our products and brand.",
          "Developed and delivered presentations to potential investors, showcasing our company and products.",
          "Engaged in product/brand promotion initiatives to increase market awareness.",
