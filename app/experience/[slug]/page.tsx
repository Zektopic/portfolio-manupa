...
function TechLogo({ name, logo }: { name: string; logo: string }) {
  return (
    <div className="flex flex-col items-center gap-1.5">
      ...
      />
      <div
        className="w-10 h-10 rounded-lg bg-slate-200/60 items-center justify-center hidden"
      >
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50/50 to-indigo-50/50">
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-12">
        ...
        {/* Positions (for multi-position companies like Azend) */}
        {hasPositions && (
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {/* Description (for single-position companies) */}
        ...
        {/* Business Development (if present) */}
        ...
        {/* Project Gallery (placeholder images) */}
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
